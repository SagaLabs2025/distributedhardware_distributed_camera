...
#ifndef OHOS_DISTRIBUTED_CAMERA_SINK_IMPL_H
#define OHOS_DISTRIBUTED_CAMERA_SINK_IMPL_H
...
class DistributedCameraSinkImpl : public IDistributedCameraSink {
public:
    DistributedCameraSinkImpl();
    ~DistributedCameraSinkImpl() override;

    int32_t InitSink(const std::string& params,
                    std::shared_ptr<IDCameraSinkCallback> callback) override;
...
private:
    ...
    std::shared_ptr<IDCameraSinkCallback> callback_;
...
#endif // OHOS_DISTRIBUTED_CAMERA_SINK_IMPL_H